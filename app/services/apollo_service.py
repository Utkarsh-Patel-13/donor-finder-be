...
class ApolloService:
    ...
    async def search_organizations(
        ...
        try:
            ...
            if query:
                search_params["q_organization_name"] = query
    ...
    async def enrich_organization(
        ...
        """Enrich organization data using Apollo.io."""
        try:
            # Prepare organization enrichment data
            ...
            response = await self.client.post(url, json=org_data)
            response.raise_for_status()
